...
\subtitle{Adam Smith Business School\\
University of Glasgow\\\vspace{2cm}}
...
% \begin{frame}{Wenbin Wu}
%     \begin{itemize}
%         \item \textbf{Current Research Focus}
%         \begin{itemize}
%             \item Computational finance and DeFi using agent-based modelling.
%         \end{itemize}
