...
def test_motherduck_get_dataframe(motherduck_client):
    ...
    # Assuming your _execute_query method correctly transforms the result into a DataFrame
    assert not df.empty
    motherduck_client.client.execute.assert_called_once()

# You can now add more tests and use the bigquery_client and motherduck_client fixtures
# to initialize your client objects. This approach keeps your test code DRY (Don't Repeat Yourself).